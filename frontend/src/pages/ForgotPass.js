...
import { resetAction, changePasswordAction } from "../api/userActions";

import { useNavigate } from "react-router-dom";
import { openMessageError, openMessageSuccess } from "../utils/Verifications";
        ...
        <Row gutter={0}>
            <Col xs={0} md={14} span={24}>
                <div id="left-container">
                    ...
                    <img id="img" alt="ForgotPass svg" src={login} />
                </div>
            </Col>
